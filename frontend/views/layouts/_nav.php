...
<div class="order_nav w100" id="hdNav">
    <ul>
        <?php if(isset($sel) && $sel): ?>
            ...
            <li class="order_total"><a href="/forder/bycount" class="<?= $sel == 'bycount' ? 'act': ''; ?>"><?= ConfigModel::getSeasonInfo()['season_title']; ?>汇总</a></li>
        ...
        <?php else: ?>
            ...
            <li class="order_total"><a href="/downuser/bydowncount?purchase_id=<?= $purchase_id; ?>&customer_id=<?= $customer_id; ?>" class="<?= $down == 'bydowncount' ? 'act': ''; ?>"><?= ConfigModel::getSeasonInfo()['season_title']; ?>汇总</a></li>
